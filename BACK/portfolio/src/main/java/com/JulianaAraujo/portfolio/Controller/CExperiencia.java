...
import com.JulianaAraujo.portfolio.Dto.dtoExperiencia;
import com.JulianaAraujo.portfolio.Entity.Experiencia;
import com.JulianaAraujo.portfolio.Security.Controller.Mensaje;
import com.JulianaAraujo.portfolio.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        //compara experiencias nuevas con las ya agregadas(por nombre)
        if(sExperiencia.existsByNombreE(dtoexp.getNombreE()) && 
